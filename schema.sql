...
VALUES ("Bamazon Brime Bideo Bubscription", "Bamazon Bideo", 29.99, 999),("Tesla Roadster (Battery Not Included)", "Bautomotive", 200000, 2),("Quantum Difibrillator", "Bumputers", 999999.99, 1),("Stem Cells", "Bealth & Beauty", 125000, 25),("Wacbook Bro", "Bumputers", 1999.99, 90),("Michael Kors Human Leather Purse", "Bapparel & Bashion", 179.99, 25),("Binal Bantasy BII", "Bideo Games", 69.99, 77),("Battlers of Batan", "Board Games", 49.99, 15),("Bandai Gundam (PTSD enabled)", "Billitary R & B", 727910000.79, 1),("Buscle Bulk Brotein Powder", "Bealth & Bitness", 49.99, 20);
